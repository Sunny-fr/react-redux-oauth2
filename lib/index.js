...
}, _defineProperty(_actions, 'load_user', function load_user(user, token) {
    return {
        type: 'OAUTH_LOAD_USER',
    ...
    oauth: function oauth() {
        ...
        switch (actions.type) {
            ...
            case 'OAUTH_LOAD_TOKEN':
                return _extends({}, state, { authenticating: false, user: '', token: actions.payload.token, error: null });
                break;
            case 'OAUTH_SAVE_TOKEN':
                return _extends({}, state, { authenticating: false, user: '', token: actions.payload, error: null });
                break;
            case 'OAUTH_SIGNOUT':
